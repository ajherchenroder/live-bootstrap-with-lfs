...
cd sudo-1.9.14p3
./configure --prefix=/usr --libexecdir=/usr/lib --with-secure-path --with-all-insults \ 
  --with-env-editor --docdir=/usr/share/doc/sudo-1.9.14p3 --with-passprompt="[sudo] password for %p: "
make
make install &&
